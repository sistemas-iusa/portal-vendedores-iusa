<template>
  <!-- .auth -->
  <main class="auth">
    <header id="auth-header" class="auth-header" style="background:#FF000A; color:#ffffff;">
      <h1>
        <!-- <svg
    ...
    <form class="auth-form" @submit.prevent="submit">
      ...
      <!-- /.form-group -->
      <!-- .form-group sitekey="6Lefo8kUAAAAANnsSS5MfvDnzzniSQ0f3Nfc6U_A" -->
      <!-- .form-group sitekey="6Lcr9EAbAAAAAMZPVx_M7X9iTEJsO1WZ73-CjhJi" -->
    ...
    <!-- <footer class="auth-footer">
      © 2021 All Rights Reserved. <a>Privacy</a> and
      <a>Terms</a>
    </footer> -->
