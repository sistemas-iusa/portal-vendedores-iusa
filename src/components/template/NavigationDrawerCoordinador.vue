<template>
  <div>
    <v-app-bar
      color="#FF000A"
      dark
      v-if="authenticated && authenticated.type == '3'"
    >
      ...
      <h6 style="font-size: 22px">Coordinador</h6></v-toolbar-title>
      <v-spacer></v-spacer>
        ...
        >
          ...
          >
            <v-list-item>
              ...
              <v-list-item-title>Generar Ruta</v-list-item-title>
            </v-list-item>
          </router-link>
          <router-link
          ...
          >
            <v-list-item>
              ...
              <v-list-item-title>Seguimiento Ruta</v-list-item-title>
            </v-list-item>
          </router-link>
